...
int main() {
  ...
  while (opcao != 4) { // laço infinito para manter o menu em execução
    ...
    // solicita o caminho da imagem ao usuário
      ...
      float** image = alocar(altura, largura);
    ...
    if (caminhoImagem[0] == '\0') {
      ...
      case 1: 
        ...
        printf("Filtro Negativo aplicado com sucesso!\n");
        break;

      case 2: 
        aplicar_filtro_espelhamento(altura, largura, image);
        printf("Filtro de Espelhamento aplicado com sucesso!\n");
        break;

      case 3: 
        aplicar_filtro_borramento(altura, largura, image);
        printf("Filtro de Borramento aplicado com sucesso!\n");
        break;

      case 4: 
        aplicar_filtro_clareamento(altura, largura, image);
        printf("Filtro de Clareação aplicado com sucesso!\n");
        break;
